...
export const sources = new Map<Sources, string>([
  ...
  [Sources.Main, 'hhttps://raw.githubusercontent.com/discordjs/discord.js/docs/main.json'],
  ...
  [Sources.Builders, 'https://github.com/discordjs/builders/blob/docs/stable.json'],
